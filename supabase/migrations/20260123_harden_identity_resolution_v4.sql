-- =====================================================
-- HARDEN IDENTITY RESOLUTION V4 (Total Compatibility)
-- =====================================================
-- NOTE: We must DROP the function first because the return 
-- type (dual keys) is different from the previous version.
